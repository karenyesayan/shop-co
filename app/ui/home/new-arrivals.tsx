...
export default async function NewArrivals() {
  ...
  return (
    <section
      id="new-arrivals"
      className="flex flex-col items-center px-4 pt-12.5 xl:mx-auto xl:max-w-310 xl:px-0 xl:pt-18"
    >
      ...
      <hr className="mt-[2.4375rem] h-px w-full border-0 bg-[rgba(0,0,0,0.1)] xl:mt-16" />
    </section>
  );
}
