...
export function MenuButton({
  ...
  return (
    <button
      ...
      className="group/menu-button mr-4 lg:hidden"
    >
      <span className="sr-only">Open mobile menu</span>
      <BarsIcon className="size-6 fill-black stroke-black group-hover/menu-button:fill-[rgba(0,0,0,0.4)] group-hover/menu-button:stroke-[rgba(0,0,0,0.4)]" />
    </button>
  );
}
...
export function LogoutButton() {
  ...
  return (
    <button
      onClick={logout}
      className="flex w-full cursor-pointer flex-row items-center gap-3 rounded border-b-0 border-solid border-[rgba(0,0,0,0.1)] py-4 text-base text-[rgba(0,0,0,0.6)] hover:text-[#FF3333] md:hover:font-semibold 2xl:px-4"
    >
...
export function PrevButton({
  ...
  return (
    <button
      className="group/prev z-[1] m-0 box-border flex inline-flex h-9 w-8 cursor-pointer touch-manipulation appearance-none items-center justify-center rounded-lg border-0 bg-transparent p-0 text-black no-underline disabled:text-[rgb(192,192,192)]"
      type="button"
      style={{
    ...
    >
      <svg
        className="size-6 group-hover/prev:text-[rgb(192,192,192)]"
        viewBox="0 0 20 16"
        fill="none"
...
export function NextButton({
  ...
  return (
    <button
      className="group/next z-[1] m-0 box-border flex inline-flex h-9 w-8 cursor-pointer touch-manipulation appearance-none items-center justify-center rounded-lg border-0 bg-transparent p-0 text-black no-underline disabled:text-[rgb(192,192,192)]"
      type="button"
      style={{
        WebkitTapHighlightColor: "rgba(49, 49, 49, 0.5)",
        WebkitAppearance: "none",
    ...
    >
      <svg
        className="size-6 group-hover/next:text-[rgb(192,192,192)]"
        viewBox="0 0 20 16"
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
      >
